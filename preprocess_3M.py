...
def construct_neighbor_graph(adata_omics1, adata_omics2, adata_omics3, n_neighbors=3):
    ...
    if adata_omics3 is not None:
        ...
        # 双模态情况
        feature_graph_omics1, feature_graph_omics2 = construct_graph_by_feature_2modal(adata_omics1, adata_omics2)
...
def construct_graph_by_feature_2modal(adata_omics1, adata_omics2, k=20, mode="connectivity",
                                      metric="correlation", include_self=False):
    """Constructing feature neighbor graph for two modalities only"""
...
def adjacent_matrix_preprocessing(adata_omics1, adata_omics2, adata_omics3):
    ...
    if adata_omics3 is not None:
        ...
        adj['adj_spatial_omics3'] = adj_spatial_omics3
        adj['adj_feature_omics3'] = adj_feature_omics3
