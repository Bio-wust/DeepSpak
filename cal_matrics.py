...
if __name__ == "__main__":
    ...
    parser.add_argument('--GT_path', default='E:/code/mymodel2/data/HLN/GT_labels.txt', type=str, help='GT_path')
    # parser.add_argument('--SpatialGlue_path', default='', type=str, help='SpatialGlue_path')
    parser.add_argument('--our_path', default='SpatialGlue/result/hln.txt', type=str, help='our_path')
    parser.add_argument('--save_path', default='SpatialGlue/results/hln_metrics.txt', type=str, help='our_path')
